...
agent_plain.py
==============
A simple customer-support agent built with LangChain + Gemini.
...
It uses Gemini to decide which tool to call and to compose the answer.
"""
...
# ---------------------------------------------------------------------------
# The agent — a LangGraph ReAct agent powered by Gemini.
# ---------------------------------------------------------------------------
